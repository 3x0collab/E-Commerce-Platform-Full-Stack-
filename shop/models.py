...
class Product(models.Model):
    ...
    product_image2 = models.ImageField(default='default_product.jpg', upload_to='products')
    product_image1 = models.ImageField(default='default_product.jpg', upload_to='products')
...
class contact_us(models.Model):
    ...
    subject = models.TextField(max_length=250, null=False)
